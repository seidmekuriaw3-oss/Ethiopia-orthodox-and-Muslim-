...
PRODUCTS = [
    ...
    ("Habesha Kemis", "ሀበሻ ቀሚስ", 8, 3800, 5200, 18, "product_habesha_kemis.jpg", 1, "women"),
    ("Modern Abaya", "ዘመናዊ አባያ", 8, 2600, 3400, 22, "product_002.jpg", 0, "women"),
    ("Ethiopian Netela Gabi", "የኢትዮጵያ ነጠላ ጋቢ", 8, 2200, 2900, 25, "product_gabi.jpg", 0, "unisex"),
    ("Elegant Evening Gown", "ውብ የምሽት ቀሚስ", 1, 4200, 5800, 10, "evening_gown.jpg", 1, "women"),
    ("Luxury Floral Dress", "የአበባ ንድፍ ቀሚስ", 1, 2100, 2900, 20, "product_floral_maxi.jpg", 1, "women"),
    ("Casual Maxi Dress", "ካዥዋል ማክሲ ቀሚስ", 1, 1650, 2200, 28, "maxi_dress.jpg", 0, "women"),
    ("Classic Polo Shirt", "ክላሲክ ፖሎ ሸሚዝ", 2, 900, 1300, 40, "tshirt.jpg", 0, "men"),
    ("Men's Formal Shirt", "የወንዶች መደበኛ ሸሚዝ", 2, 1100, 1500, 35, "product_white_shirt.jpg", 0, "men"),
    ("Floral Crop Top", "የአበባ ክሮፕ ቶፕ", 2, 650, 950, 45, "printed_blouse.jpg", 1, "women"),
    ("High Waist Jeans", "ከፍ ያለ ወገብ ጂንስ", 3, 1500, 2100, 30, "jeans.jpg", 1, "women"),
    ("Slim Fit Chinos", "ስሊም ፊት ቺኖስ", 3, 1300, 1800, 26, "product_chinos.jpg", 0, "men"),
    ("Cargo Shorts", "ካርጎ ቁምጣ", 3, 850, 1200, 32, "product_denim_shorts.jpg", 0, "men"),
    ("Denim Jacket", "ጂንስ ጃኬት", 4, 2000, 2700, 18, "denim_jacket.jpg", 1, "unisex"),
    ("Knit Cardigan", "ሹራብ ካርዲጋን", 4, 1400, 1900, 24, "cardigan.jpg", 0, "women"),
    ("Leather Biker Jacket", "የቆዳ ባይከር ጃኬት", 4, 3200, 4300, 12, "product_leather_jacket.jpg", 1, "unisex"),
    ("Silk Pajama Set", "የሐር ፒጃማ ስብስብ", 5, 1200, 1650, 20, "product_pajama.jpg", 0, "women"),
    ("Cotton Underwear Set", "የጥጥ የውስጥ ልብስ ስብስብ", 5, 550, 800, 50, "tshirt.jpg", 0, "women"),
    ("Baby Onesie Set", "የሕፃናት ልብስ ስብስብ", 6, 750, 1050, 30, "product_baby_romper.jpg", 1, "baby"),
    ("Running Sports Set", "የስፖርት ስብስብ", 7, 1350, 1850, 22, "sportswear.jpg", 1, "unisex"),
    ("Yoga Leggings", "የዮጋ ሌጊንስ", 7, 800, 1100, 38, "product_leggings.jpg", 0, "women"),
]
